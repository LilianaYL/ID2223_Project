# Euro to Swedish Krona Currency Prediction 
...
In order to predict the exchange rate between Euro and SEK, we use the currency, EU inflation rate, interest rate as feature groups, including inflation rate of different EU countries as features.
